  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <main style={{ flex: 1, overflow: 'hidden', position: 'relative' }}>
        ...
        {screen === 'planning' && <PlanningScreen interventions={interventions} zones={zones} trades={trades} companies={companies} userRole={userRole} userCompany={userCompany} onUpdate={handleUpdate} onAdd={handleAdd} onOpenNote={noteId => { setScreen('notes'); setPendingNoteId(noteId) }} onCompaniesChange={setCompanies} />}
